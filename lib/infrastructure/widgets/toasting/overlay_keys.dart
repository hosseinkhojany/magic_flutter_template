...
/// showSimpleNotification(AppText('modal example'), key: modalKey);
///
/// //when previous notification is showing, popup again whit this key
/// //this notification will be rejected.
/// showSimpleNotification(AppText('modal example 2'), key: modalKey);
///
/// ```
...
///
/// showSimpleNotification(AppText('modal example'), key: key);
///
/// // The previous notification will be dismiss immediately, instead of have
/// // a disappearing animation effect.
/// showSimpleNotification(AppText('modal example 2'), key: key);
///
/// ```
